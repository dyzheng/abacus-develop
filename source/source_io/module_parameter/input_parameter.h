...
//    bool final_scf = false;    ///< whether to do final scf
    ...
    std::string deltap_operator_mode = "proxy"; ///< Route A+ constraint operator (operator mode): "proxy" = τ_α·P̂ (H_HR proxy), "hk" = H_HK only (HK-only field mode, F-2b), "ow" = θ_n·P̂ (Ô_w band-resolved, EFC L3.1)
