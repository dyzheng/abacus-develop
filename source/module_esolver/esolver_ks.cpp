...
void ESolver_KS<T, Device>::before_all_runners(UnitCell& ucell, const Input_para& inp)
{
    ...
    ModuleBase::TITLE("ESolver_KS", "before_initmpi");
#ifdef __MPI
    this->pw_wfc->initmpi(GlobalV::NPROC_IN_POOL, GlobalV::RANK_IN_POOL, POOL_WORLD);
#endif
    ModuleBase::TITLE("ESolver_KS", "after_initmpi");
    ...
    this->pw_wfc->initgrids(inp.ref_cell_factor * ucell.lat0,
                            ...
                            this->pw_rho->ny,
                            this->pw_rho->nz);
    ModuleBase::TITLE("ESolver_KS", "after_initgrids");

    this->pw_wfc->initparameters(false, inp.ecutwfc, this->kv.get_nks(), this->kv.kvec_d.data());
    ModuleBase::TITLE("ESolver_KS", "after_initparameters");
    ...
    ModuleBase::TITLE("ESolver_KS", "after_initfftmode");
    this->pw_wfc->setuptransform();
    ModuleBase::TITLE("ESolver_KS", "after_setuptransform");
    ...
    ModuleBase::TITLE("ESolver_KS", "after_collect_local_pw");
    ...
    ModuleBase::TITLE("ESolver_KS", "before_Pgrid_init");
    Pgrid.init(this->pw_rhod->nx,
                        ...
                        pw_big->nbz,
                        pw_big->bz);
    ModuleBase::TITLE("ESolver_KS", "after_Pgrid_init");

    //! 11) calculate the structure factor
    this->sf.setup_structure_factor(&ucell, Pgrid, this->pw_rhod);
    ModuleBase::TITLE("ESolver_KS", "after_setup_structure_factor");
