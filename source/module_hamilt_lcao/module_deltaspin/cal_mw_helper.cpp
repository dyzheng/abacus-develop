...
template <>
std::vector<std::vector<std::vector<double>>> SpinConstrain<std::complex<double>>::convert(
...
template <>
void SpinConstrain<std::complex<double>>::calculate_MW(
...
template <>
void SpinConstrain<std::complex<double>>::collect_MW(ModuleBase::matrix& MecMulP,
