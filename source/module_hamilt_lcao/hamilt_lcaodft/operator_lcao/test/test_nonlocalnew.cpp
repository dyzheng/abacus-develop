...
TEST_F(NonlocalNewTest, constructHRd2d)
{
    ...
    hamilt::NonlocalNew<hamilt::OperatorLCAO<double, double>> op(&hsk, kvec_d_in, HR, &ucell, &gd, &intor_);
...
TEST_F(NonlocalNewTest, constructHRd2cd)
{
    ...
    hsk.set_zero_hk();
    Grid_Driver gd(0, 0, 0);
    hamilt::NonlocalNew<hamilt::OperatorLCAO<std::complex<double>, double>> op(&hsk,
                                                                               kvec_d_in,
                                                                               HR,
                                                                               &ucell,
                                                                               &gd,
