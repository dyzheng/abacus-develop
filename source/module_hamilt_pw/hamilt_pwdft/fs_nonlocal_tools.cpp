...
void FS_Nonlocal_tools<FPTYPE, Device>::save_vkb(int npw, int ipol)
{
    ...
    else
    {
        ...
        saveVkbValues<FPTYPE>(gcar_zero_ptrs, vkb_ptr, vkb_save_ptr, nkb, npw, gcar_zero_counts);
#endif
    }
}
...
void FS_Nonlocal_tools<FPTYPE, Device>::revert_vkb(int npw, int ipol)
{
    ...
    {
#if __CUDA || __UT_USE_CUDA || __ROCM || __UT_USE_ROCM
        revertVkbValues<FPTYPE>(gcar_zero_ptrs, vkb_ptr, vkb_save_ptr, nkb, npw, gcar_zero_counts, coeff);
#endif
    }
}
